...
from .communication_errors import PacketContentsError, PacketStructureError
from .constants import CHARSET, SEP, END, CODES
...
def is_valid_packet_structure(content: bytes) -> bool:
    ...
    """
    try:
        return re.search(PACKET_PATTERN, content).string is not None # type: ignore
